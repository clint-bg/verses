...
chart = alt.Chart(data_plot).mark_point().encode(
    alt.X('tsne_x', scale=alt.Scale(domain=[top50['tsne_x'].min()-20, top50['tsne_x'].max()+20]), axis=None),
    alt.Y('tsne_y', scale=alt.Scale(domain=[top50['tsne_y'].min()-20, top50['tsne_y'].max()+20]), axis=None),
